...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Order Details - ' . config('app.name', 'IGP Hub')); ?>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="page-header mb-12">
                    <div class="flex items-center justify-between gap-4 mb-4">
                        ...
                        <span class="status-badge status-<?php echo e($order->status === 'completed' ? 'completed' : ($order->status === 'cancelled' ? 'cancelled' : 'pending')); ?>"><?php echo e(ucfirst($order->status)); ?></span>
                    </div>
                    <p>Placed on <?php echo e($order->created_at->format('F d, Y \a\t g:i A')); ?></p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                                ...
                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="order-item">
                                        <?php if($item->product->image_path): ?>
                                            <img src="<?php echo e(asset('storage/' . $item->product->image_path)); ?>" alt="<?php echo e($item->product->name); ?>" class="order-item-image">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <div class="flex-1">
                                            <p class="order-text font-bold" style="font-size: 16px; font-weight: 700;"><?php echo e($item->product->name); ?></p>
                                            <?php if($item->variant): ?>
                                                <p class="text-sm" style="color: #666666; margin-top: 4px;">🎨 <?php echo e($item->variant->name); ?></p>
                                            <?php endif; ?>
                                            <p class="text-sm" style="color: #888888; margin-top: 8px; font-weight: 600;">Qty: <span style="color: #1a1a1a; font-weight: 700;"><?php echo e($item->quantity); ?></span></p>
                                        </div>
                                        <div class="text-right">
                                            <p class="order-text font-bold" style="font-size: 17px; font-weight: 800;">₱<?php echo e(number_format($item->unit_price, 2)); ?></p>
                                            <p class="text-sm" style="color: #666666; margin-top: 4px; font-weight: 600;">₱<?php echo e(number_format($item->unit_price * $item->quantity, 2)); ?></p>
                                        </div>
                                    </div>
                        ...
                        <!-- Service Requests -->
                        <?php if(!empty($order->serviceRequests) && $order->serviceRequests->count() > 0): ?>
                            <div class="order-card p-8">
                                    ...
                                    <?php $__currentLoopData = $order->serviceRequests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="pb-4 border-b border-gray-200 last:border-0">
                                            <div class="flex justify-between items-start mb-3">
                                                <h3 class="order-text font-bold text-lg"><?php echo e($service->service_type); ?></h3>
                                                <span class="status-badge status-<?php echo e($service->status === 'completed' ? 'completed' : 'pending'); ?>"><?php echo e(ucfirst($service->status)); ?></span>
                                            </div>
                                            <p class="text-sm" style="color: #666666;"><?php echo e($service->description); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            ...
                            <div class="space-y-0">
                                <div class="timeline-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm" style="color: #666666;"><?php echo e($order->created_at->format('F d, Y \a\t g:i A')); ?></p>
                                    </div>
                                </div>
                                <?php if($order->completed_at): ?>
                                    <div class="timeline-item">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm" style="color: #666666;"><?php echo e($order->completed_at->format('F d, Y \a\t g:i A')); ?></p>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="timeline-item">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="action-btn btn-secondary" style="width: 100%; text-align: center;">
                            🛍️ Continue Shopping
                        </a>
                        ...
                        <div class="order-card p-8">
                            ...
                            <div class="space-y-4 mb-8 pb-8 border-b-2" style="border-color: #E8E8E8;">
                                <div class="flex justify-between">
                                    ...
                                    <span class="order-text font-bold" style="font-weight: 700;">₱<?php echo e(number_format($order->subtotal, 2)); ?></span>
                                </div>
                            </div>
                            <div class="flex justify-between mb-8">
                                <span class="order-text text-xl font-bold">Total</span>
                                <span class="order-total" style="font-size: 32px; font-weight: 800;">₱<?php echo e(number_format($order->total, 2)); ?></span>
                            </div>

                            <!-- Actions -->
                            <div class="space-y-3">
                                <a href="<?php echo e(route('orders.receipt.pdf', $order)); ?>" class="action-btn btn-primary">
                                    📄 View Receipt
                                </a>
                                
                                <?php if($order->canBeCancelled()): ?>
                                    <form id="cancelOrderForm" action="<?php echo e(route('orders.cancel', $order)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel_igp\resources\views\orders\show.blade.php ENDPATH**/ ?>