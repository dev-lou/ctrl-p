    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-xl font-bold" style="color: #b0bcc4;" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#b0bcc4'">← Orders</a>
                <h2 class="text-2xl font-bold" style="color: #ffffff;">Order #<?php echo e($order->order_number); ?></h2>
            </div>
            <p class="mt-2" style="color: #b0bcc4;"><?php echo e($order->created_at->format('F d, Y h:i A')); ?></p>
        </div>
        <div class="flex items-center gap-4">
            <?php
            ...
            ?>
            <span class="px-4 py-2 rounded-full text-sm font-bold" style="background-color: <?php echo e($statusColor); ?>; color: <?php echo e($statusTextColor); ?>;"><?php echo e(ucfirst($order->status)); ?></span>
            
            <!-- Delete Button Only -->
            <button type="button" onclick="deleteOrder(<?php echo e($order->id); ?>)" class="px-4 py-2 rounded-lg font-semibold text-sm transition-all inline-flex items-center gap-2" style="background-color: #f44336; color: white; border: 2px solid #f44336;" onmouseover="this.style.backgroundColor='#ff6b6b'; this.style.boxShadow='0 4px 6px -1px rgba(244,67,54,0.4)'" onmouseout="this.style.backgroundColor='#f44336'; this.style.boxShadow=''">
                ...
                <div class="p-6">
                    <?php $__empty_1 = true; $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between items-center pb-4 mb-4" style="border-bottom: 2px solid #b0bcc4;">
                            <div>
                                <p class="font-semibold" style="color: #ffffff;"><?php echo e($item->product->name ?? 'Product'); ?></p>
                                <p class="text-sm" style="color: #b0bcc4;">Quantity: <?php echo e($item->quantity); ?></p>
                            </div>
                            <p class="font-semibold" style="color: #ffffff;">₱<?php echo e(number_format($item->unit_price * $item->quantity, 2)); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.orders.update-status', $order)); ?>" method="POST" class="space-y-4">
                        ...
                        <select name="status" class="w-full rounded-lg px-4 py-2" style="border: 2px solid #b0bcc4; background-color: #0f1419; color: #b0bcc4;">
                            <option value="pending" <?php echo e($order->status === 'pending' ? 'selected' : ''); ?> style="background-color: #0f1419; color: #b0bcc4;">Pending</option>
                            <option value="processing" <?php echo e($order->status === 'processing' ? 'selected' : ''); ?> style="background-color: #0f1419; color: #b0bcc4;">Processing</option>
                            <option value="completed" <?php echo e($order->status === 'completed' ? 'selected' : ''); ?> style="background-color: #0f1419; color: #b0bcc4;">Completed</option>
                            <option value="cancelled" <?php echo e($order->status === 'cancelled' ? 'selected' : ''); ?> style="background-color: #0f1419; color: #b0bcc4;">Cancelled</option>
                        </select>
            ...
            <div class="rounded-lg shadow-lg overflow-hidden" style="background-color: #1a1f2e; border: 2px solid #b0bcc4;">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex justify-between" style="border-bottom: 2px solid #b0bcc4; padding-bottom: 12px;">
                        ...
                        <span style="color: #ffffff; font-weight: bold;">₱<?php echo e(number_format($order->subtotal ?? $order->total, 2)); ?></span>
                    </div>
                    <div class="flex justify-between" style="border-bottom: 2px solid #b0bcc4; padding-bottom: 12px;">
                        <span style="color: #b0bcc4;">Tax</span>
                        <span style="color: #ffffff; font-weight: bold;">₱<?php echo e(number_format($order->tax ?? 0, 2)); ?></span>
                    </div>
                    <div class="flex justify-between pt-4" style="border-top: 2px solid #b0bcc4;">
                        ...
                        <span style="color: #ffffff; font-weight: bold; font-size: 18px;">₱<?php echo e(number_format($order->total, 2)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg shadow-lg overflow-hidden mt-6" style="background-color: #1a1f2e; border: 2px solid #b0bcc4;">
                ...
                <div class="p-6 space-y-3">
                    <div>
                        ...
                        <p style="color: #ffffff; font-weight: bold;"><?php echo e($order->user->name ?? 'Unknown'); ?></p>
                    </div>
                    <div style="border-top: 2px solid #b0bcc4; padding-top: 12px;">
                        <p style="color: #b0bcc4; font-size: 12px;">Email</p>
                        <p style="color: #ffffff; font-weight: bold;"><?php echo e($order->user->email ?? 'N/A'); ?></p>
                    </div>
                </div>
            </div>
        </div>
