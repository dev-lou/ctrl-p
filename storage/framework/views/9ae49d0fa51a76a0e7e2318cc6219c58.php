            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <form method="POST" action="<?php echo e(route('checkout.store')); ?>">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="order-item">
                                            ...
                                            <div class="order-item-details">
                                                ...
                                                <?php if($item['variant']): ?>
                                                    <div class="order-item-variant">🎨 <?php echo e($item['variant']->name); ?></div>
                                                <?php endif; ?>
                                                <div class="order-item-qty">Qty: <?php echo e($item['quantity']); ?></div>
                                                <div style="color: #666666; font-size: 14px; font-weight: 600; margin-top: 4px;">Unit Price: ₱<?php echo e(number_format($item['price'], 2)); ?></div>
                                            </div>
                                            <div style="text-align: right; display: flex; flex-direction: column; justify-content: center;">
                                                <div style="color: #888888; font-size: 13px; margin-bottom: 4px;">Subtotal</div>
                                                <div class="order-item-price">₱<?php echo e(number_format($item['total'], 2)); ?></div>
                                            </div>
                                        </div>
                        ...
                        <a href="<?php echo e(route('cart.index')); ?>" class="back-btn" style="width: 100%; text-align: center; margin-bottom: 16px; display: flex; align-items: center; justify-content: center;">
                            ← Back to Cart
                        </a>
                        ...
                        <div class="order-summary-card p-8 sticky top-28 h-fit">
                            ...
                            <div class="summary-total-row pb-4">
                                ...
                                <span class="summary-total-value">₱<?php echo e(number_format($subtotal, 2)); ?></span>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel_igp\resources\views\checkout\index.blade.php ENDPATH**/ ?>