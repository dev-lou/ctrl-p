...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'Login - CICT Merch']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div class="auth-card">
                ...
                <div class="auth-footer">
                    <p class="auth-footer-text">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="auth-link">Create one</a>
                    </p>
                </div>
            </div>
        </div>
