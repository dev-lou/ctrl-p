...
<head>
    ...
    <title>Sales Receipt #<?php echo e($order->id); ?></title>
    <style>
...
<body>
    <div class="receipt-container">
        ...
        <div class="header-section">
            <div class="header-left">
                <div class="business-info">
                    <h1><?php echo e(strtoupper(config('app.name', 'IGP Hub'))); ?></h1>
            ...
            <div class="header-right">
                <div class="document-info">
                    <h2>SALES RECEIPT</h2>
                    <div class="document-info-row"><strong>Receipt #:</strong> IGP-<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?> <strong style="margin-left: 15px;">Date:</strong> <?php echo e($order->created_at->format('M d, Y')); ?> <strong style="margin-left: 15px;">Time:</strong> <?php echo e($order->created_at->format('g:i A')); ?> <strong style="margin-left: 15px;">Payment:</strong> Cash/GCash</div>
                    <div class="receipt-number">#<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="customer-order-section">
            <div class="customer-info">
                ...
                <div class="info-block-content">
                    <strong><?php echo e($order->customer ? $order->customer->name : 'N/A'); ?></strong>
                </div>
                <div class="info-block-content">
                    <?php echo e($order->customer ? $order->customer->email : 'N/A'); ?>
            ...
            <div class="order-info">
                ...
                <span class="status-badge status-<?php echo e(strtolower($order->status)); ?>"><?php echo e(ucfirst($order->status)); ?></span>
            ...
            <table class="items-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="item-number"><?php echo e($index + 1); ?></td>
                            <td>
                                <span class="item-name"><?php echo e(substr($item->product->name, 0, 35)); ?></span>
                            </td>
                            <td>
                                <?php if($item->variant): ?>
                                    <span class="item-variant"><?php echo e(substr($item->variant->name, 0, 25)); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-right">
                                <span class="item-price">₱<?php echo e(number_format($item->unit_price, 2)); ?></span>
                            </td>
                            <td class="text-right">
                                <span class="item-price">₱<?php echo e(number_format($item->total_price, 2)); ?></span>
                            </td>
                        </tr>
            ...
            <div class="summary-right">
                <div class="financial-summary">
                    <div class="summary-row">
                        ...
                        <span class="summary-row-value">₱<?php echo e(number_format($order->items->sum('total_price'), 2)); ?></span>
                    </div>
                    <?php if($order->discount > 0): ?>
                        <div class="summary-row discount">
                            <span class="summary-row-label">Discount:</span>
                            <span class="summary-row-value">-₱<?php echo e(number_format($order->discount, 2)); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="summary-row grand-total">
                        <span class="summary-row-label">GRAND TOTAL:</span>
                        <span class="summary-row-value">₱<?php echo e(number_format($order->total, 2)); ?></span>
                    </div>
                </div>
                ...
                <div class="payment-info">
                    <div class="payment-row">
                        ...
                        <span class="payment-row-value">₱<?php echo e(number_format($order->total, 2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-footer">
            ...
            <p class="footer-subtext"><?php echo e(config('app.name', 'IGP Hub')); ?> - Student Council Merchandise & Services</p>
            <p class="footer-timestamp">Generated <?php echo e(now()->format('M d, Y H:i:s')); ?> • Receipt #IGP-<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></p>
        </div>

    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel_igp\resources\views\receipts\pdf.blade.php ENDPATH**/ ?>