<x-admin-layout>
    ...
    <div style="display: grid; grid-template-columns: 1fr 360px; gap: 28px; margin-bottom: 40px;" class="main-container">
        ...
        <div style="min-width: 0;">
            <form id="productForm" action="{{ route('admin.inventory.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="section-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="form-input" placeholder="Enter product name" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" value="{{ old('slug') }}" class="form-input" placeholder="auto-generated from product name" style="background: #0f1419; opacity: 0.8;" />
                        <p style="color: #94a3b8; font-size: 0.85rem; margin-top: 10px;">Auto-generated from product name. Edit manually if needed.</p>
                        @error('slug')<span style="color: #ff9500; font-size: 0.95rem; font-weight: 600; margin-top: 6px; display: block;">❌ {{ $message }}</span>@enderror
                    </div>

                    <div class="form-group">
                        <label class="form-label">Description</label>
                        <textarea name="description" rows="5" class="form-input" style="resize: none; font-size: 1rem;" placeholder="Add product description...">{{ old('description') }}</textarea>
                    ...
                    <div class="input-group">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="number" name="base_price" value="{{ old('base_price') }}" step="0.01" required class="form-input" placeholder="0.00" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="low_stock_threshold" value="{{ old('low_stock_threshold', 20) }}" class="form-input" min="1" required>
                    ...
                    <div style="margin-top: 28px; padding-top: 24px; border-top: 1px solid rgba(71, 85, 105, 0.3);">
                        ...
                        <div class="form-group" style="margin-bottom: 12px;">
                            ...
                            <input type="number" name="current_stock" value="{{ old('current_stock', 0) }}" min="0" required class="form-input" placeholder="0" />
                            @error('current_stock')<span style="color: #fca5a5; font-size: 0.85rem; font-weight: 600; margin-top: 6px; display: block;">❌ {{ $message }}</span>@enderror
                        </div>
